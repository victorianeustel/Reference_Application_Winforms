...
using CommandDictionary.Properties;
...
namespace CommandDictionary.FormControls
{
    public class ListGroup : ListView
    {
        ...
        public ListGroup() : base()
        {
            ...
            this.SmallImageList.Images.Add(COLLAPSED_IMAGE_KEY, Resources.CollapsedGroupSmall_png_1616);
            this.SmallImageList.Images.Add(EXPANDED_IMAGE_KEY, Resources.ExpandedGroupSmall_png_1616);
            this.SmallImageList.Images.Add(EMPTY_IMAGE_KEY, Resources.EmptyGroupSmall_png_1616);
